...
#DOES NOT RETURN MEAN! IT RETURNS SUM.
def downsample(myarr,factor,estimator=mean):
    ...
    return dsarr*(factor**2.0) ##MUST RETURN SUM, NOT AVG
#DOES NOT RETURN MEAN! i THINK IT RETURNS SUM... DON'T USE THIS ANYWAYS.
